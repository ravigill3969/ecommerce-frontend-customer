...
const Login: React.FC = () => {
  ...
  const onSubmit = async (data: LoginFormInputs) => {
    ...
    // You can send data to your API here (e.g. using fetch/axios)
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8 hover:shadow-purple-500/25 transition-all duration-500"
             style={{
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Welcome back</h2>
            <p className="text-gray-300 mt-2 text-lg">Please sign in to your account</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {errors.email && (
                <p className="mt-3 text-sm text-red-400 font-medium">{errors.email.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.password && (
                <p className="mt-3 text-sm text-red-400 font-medium">{errors.password.message}</p>
              )}
            </div>
