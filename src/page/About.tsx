    ...
    <div className="min-h-screen bg-white px-6 py-12 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-600">
          At [Your Company Name], we are passionate about building products that
          solve real-world problems. With a team of dedicated engineers,
          designers, and thinkers, we turn complex ideas into elegant solutions
          — fast, scalable, and user-first.
        </p>
      </div>
      ...
      <div className="mt-16 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        ...
        <div className="bg-gray-50 p-6 rounded-2xl shadow-md">
          ...
          <p className="mt-4 text-gray-600">
            To become a globally recognized name in innovation, driven by values
            and community.
          </p>
        </div>
        <div className="bg-gray-50 p-6 rounded-2xl shadow-md">
          <h3 className="text-xl font-semibold text-indigo-700">Our Values</h3>
          <p className="mt-4 text-gray-600">
